...
Install and configure GitHub CLI from [https://cli.github.com/manual/](https://cli.github.com/manual/). Authenticate with `gh auth login` and ensure that it works, e.g. `gh issue list`.
